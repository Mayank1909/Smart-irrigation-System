...
String apiKey = "7TOSSLP3HCIJP4ZW";     //  Enter your Write API key here
const char* server = "api.thingspeak.com";
const char *ssid =  "moto g(9) 8875";     // Enter your WiFi Name
const char *pass =  "maya2000"; // Enter your WiFi Password
...
void loop()
{
  ...
  r = ( 100.00 - ( (analogRead(rainPin) / 1023.00) * 100.00 ) );
...
void sendThingspeak() {
  if (client.connect(server, 80))
  {
    ...
    postStr += "&field2=";
    postStr += String(t);                 // add tempr reading
    postStr += "&field3=";
    ...
    Serial.print(moisturePercentage);
    Serial.print("RainWater percentage :");
    Serial.print(r);
